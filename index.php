    ...
    <div class="header-content">
      <div class="row">
        <div class="col-md-5 my-auto mx-auto" data-aos="fade-right">
          <h2>Toko Fahmi</h2>
          <p>
            Toko fahmi adalah toko online jualan komputer paling komplit se RT 4
          </p>
  ...
  <section class="footer bg-dark" id="contact">
    <div class="footer-content">
      ...
      <div class="row">
        ...
        <div class="col-md-5 my-3 mx-auto" data-aos="fade-in">
          <h4 class="text-light text-poppins font-weight-bold">Toko Fahmi</h4>
          <p class="d-block font-weight-light text-light">
            Toko Fahmi adalah aplikasi berbelanja online dengan fasilitas memadai
          </p>
        </div>
      </div>
      <div class="row">
